...
public class FrescoUtil {
  ...
  public static final String DOWNLOAD_PATH = "/data/data/com.gyj.zhihu/cache/";
  ...
  public static void savePicture(String picUrl,Context context) {
    ...
    File picDir = new File(DOWNLOAD_PATH);

    if (!picDir.exists()) {
      picDir.mkdir();
    }
    CacheKey cacheKey = DefaultCacheKeyFactory.getInstance().getEncodedCacheKey(ImageRequest.fromUri(
        Uri.parse(picUrl)),null);
  ...
  public static void downLoadImage(Uri uri, final String filename, Context context) {
    ...
    dataSource.subscribe(new BaseBitmapDataSubscriber() {
      ...
      public void onNewResultImpl(Bitmap bitmap) {
        ...
        File appDir = new File(DOWNLOAD_PATH);
        if (!appDir.exists()) {
          appDir.mkdir();
        }
